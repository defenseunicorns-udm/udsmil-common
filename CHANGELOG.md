...
* adding renovate to keep dependencies up to date ([5a94a77](https://github.com/defenseunicorns-udm/udm-common/commit/5a94a771e8b6260cdef79484b1f1cb4abbf55221))
...
* correct renovate config and pin SHAs to v0.2.0 release after rename ([75b119d](https://github.com/defenseunicorns-udm/udm-common/commit/75b119d408ee07e9eac7a3a22f658262a2ee8119))
* correct renovate config and pin SHAs to v0.2.0 release after rename ([cbd006f](https://github.com/defenseunicorns-udm/udm-common/commit/cbd006f7a80570cf7f546ad07d31511f3e8cc291))
