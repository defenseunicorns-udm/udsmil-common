...
```yaml
uses: defenseunicorns-udm/udm-common/.github/actions/security-scan@f366c21d12c7699f7db5eabe7cde129071bdee79
```
...
jobs:
  lint:
    ...
    steps:
      ...
      - uses: defenseunicorns-udm/udm-common/.github/actions/uds-cli-setup@f366c21d12c7699f7db5eabe7cde129071bdee79
  ...
  scan-and-vouch:
    ...
    steps:
      ...
      - id: scan
        uses: defenseunicorns-udm/udm-common/.github/actions/security-scan@f366c21d12c7699f7db5eabe7cde129071bdee79
      - uses: defenseunicorns-udm/udm-common/.github/actions/vouch@f366c21d12c7699f7db5eabe7cde129071bdee79
        with:
  ...
  publish:
    ...
    steps:
        uses: actions/checkout@v6.0.2
      - uses: defenseunicorns-udm/udm-common/.github/actions/uds-cli-setup@f366c21d12c7699f7db5eabe7cde129071bdee79
      - uses: defenseunicorns-udm/udm-common/.github/actions/publish@f366c21d12c7699f7db5eabe7cde129071bdee79
        with:
