...
```yaml
uses: defenseunicorns-udm/udm-common/.github/actions/security-scan@1ec00936f5c3fcfcc8a3fd4c1b4d2e3b0df104e2 # v0.5.0
```
...
jobs:
  ...
  scan-and-vouch:
    ...
    steps:
      ...
      - id: scan
        uses: defenseunicorns-udm/udm-common/.github/actions/security-scan@1ec00936f5c3fcfcc8a3fd4c1b4d2e3b0df104e2 # v0.5.0
      - uses: defenseunicorns-udm/udm-common/.github/actions/vouch@1ec00936f5c3fcfcc8a3fd4c1b4d2e3b0df104e2 # v0.5.0
        with:
  ...
  publish:
    ...
    steps:
        uses: actions/checkout@v6.0.2
      - uses: defenseunicorns-udm/udm-common/.github/actions/uds-cli-setup@1ec00936f5c3fcfcc8a3fd4c1b4d2e3b0df104e2 # v0.5.0
      - uses: defenseunicorns-udm/udm-common/.github/actions/publish@1ec00936f5c3fcfcc8a3fd4c1b4d2e3b0df104e2 # v0.5.0
        with:
